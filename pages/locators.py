...
class MainPageLocators:
    BUTTON_BUY_MEGATARIF = (By.CSS_SELECTOR, '.swiper-wrapper > div:nth-child(3) .TariffCardBottom-module__buyButton--oq0nm')
    BUTTON_BUY_SIM_OR_ESIM = (By.CSS_SELECTOR, '.BuyModal-module__block--v0nIV > div:nth-child(1)')
...
class BasketPageLocators:
    ...
    # СПОСОБ ПОЛУЧЕНИЯ
    GET_METHOD_PICKUP = (By.CSS_SELECTOR, '.Checkout-module__main--a-NUG .OptionsWrapper-module__options--I4ac4 > div:nth-child(2)')
    ...
    # СПОСОБ ОПЛАТЫ
    PAYMENT_METHOD_CASH = (By.CSS_SELECTOR, '.Checkout-module__main--a-NUG > div:nth-child(2) > div > div:nth-child(5) > div.OptionsWrapper-module__options--I4ac4 > div:nth-child(1)')
