# е2е unittest Оформление заказа на подключение МегаТариф
import unittest                                  # Модуль Юнит-тест
